...
`is_moving`, `is_parking`, `is_stationary_running`, vitesse, cap, contact et
...
identite du vehicule, emplacement, conducteur identifie par RFID/iButton/NFC,
alimentation, GSM, diagnostic, OBD/CAN et cinq derniers evenements. L'IMEI,
l'identifiant interne, le nom et le modele technique du traceur restent exclus.
