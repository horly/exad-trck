...
function tr(e, t, i, s) {
  e = jr(e), e = Gr(e, i.decPrivateModes.bracketedPasteMode && s.rawOptions.ignoreBracketedPasteMode !== !0), i.triggerDataEvent(e, !0), t.value = "";
}
function ir(e, t, i) {
...
function hs(e, t, i, s, r) {
  ir(e, t, i), r && s.rightClickSelect(e), t.value = s.selectionText, t.select();
}
function Ke(e) {
  return e > 65535 ? (e -= 65536, String.fromCharCode((e >> 10) + 55296) + String.fromCharCode(e % 1024 + 56320)) : String.fromCharCode(e);
}
function Xt(e, t = 0, i = e.length) {
  let s = "";
  for (let r = t; r < i; ++r) {
    let n = e[r];
...
var Qr = class {
  ...
  constructor() {
    this.fg = 0, this.bg = 0, this.extended = new $t();
  }
  static toColorRGB(t) {
  ...
  clone() {
    return new nr(this._ext, this._urlId);
  }
  isEmpty() {
...
}, ls = "di$target", pi = "di$dependencies", ei = /* @__PURE__ */ new Map();
function tn(e) {
  return e[pi] || [];
}
function re(e) {
...
var jt = re("CharSizeService"), Oe = re("CoreBrowserService"), Ji = re("MouseService"), Ie = re("RenderService"), an = re("SelectionService"), cr = re("CharacterJoinerService"), ot = re("ThemeService"), dr = re("LinkProviderService"), hn = class {
  constructor() {
    this.listeners = [], this.unexpectedErrorHandler = function(e) {
      setTimeout(() => {
        throw e.stack ? cs.isErrorNoTelemetry(e) ? new cs(e.message + `
...
function It(e) {
  cn(e) || ln.onUnexpectedError(e);
}
var vi = "Canceled";
function cn(e) {
  return e instanceof dn ? !0 : e instanceof Error && e.name === vi && e.message === vi;
}
var dn = class extends Error {
  constructor() {
    super(vi), this.name = this.message;
  }
};
function un(e) {
  return new Error(`Illegal argument: ${e}`);
}
var cs = class mi extends Error {
  constructor(t) {
...
((e) => {
  ...
  e.from = o;
  function* h(B) {
    for (let M = B.length - 1; M >= 0; M--) yield B[M];
  }
  e.reverse = h;
  function l(B) {
...
var fr = class pr {
  ...
  add(t) {
    ...
    return this._isDisposed ? pr.DISABLE_DISPOSED_WARNING || console.warn(new Error("Trying to add a disposable to a DisposableStore that has already been disposed of. The added object will be leaked!").stack) : this._toDispose.add(t), t;
  }
  delete(t) {
    if (t) {
...
}, Ae = typeof window == "object" ? window : globalThis, wi = class bi {
  constructor(t) {
    this.element = t, this.next = bi.Undefined, this.prev = bi.Undefined;
  }
};
...
var K = wi, ds = class {
  ...
  *[Symbol.iterator]() {
  ...
  constructor(t) {
    this._now = gn && t === !1 ? Date.now : globalThis.performance.now.bind(globalThis.performance), this._startTime = this._now(), this._stopTime = -1;
  }
  stop() {
...
yi.all = /* @__PURE__ */ new Set(), yi._idPool = 0;
var mn = yi, Sn = -1, vr = class mr {
  constructor(t, i, s = (mr._idPool++).toString(16).padStart(3, "0")) {
...
vr._idPool = 1;
var wn = vr, bn = class Sr {
  constructor(t) {
    this.value = t;
  }
  static create() {
    let t = new Error();
    return new Sr(t.stack ?? "");
  }
  print() {
...
`));
  ...
  _deliver(e, t) {
    if (!e) return;
    let i = this._options?.onListenerError || It;
    if (!i) {
      e.value(t);
      return;
    }
  ...
  fire(e) {
    if (this._deliveryQueue?.current && (this._deliverQueue(this._deliveryQueue), this._perfMon?.stop()), this._perfMon?.start(this._size), this._listeners) if (this._listeners instanceof ti) this._deliver(this._listeners, e);
    else {
...
Zi.INSTANCE.onDidChangeZoomLevel;
function Rn(e) {
  return Zi.INSTANCE.getZoomFactor(e);
}
Zi.INSTANCE.onDidChangeFullscreen;
var at = typeof navigator == "object" ? navigator.userAgent : "", xi = at.indexOf("Firefox") >= 0, Ln = at.indexOf("AppleWebKit") >= 0, Qi = at.indexOf("Chrome") >= 0, Mn = !Qi && at.indexOf("Safari") >= 0;
at.indexOf("Electron/") >= 0;
at.indexOf("Android") >= 0;
var ii = !1;
if (typeof Ae.matchMedia == "function") {
  ...
  ii = e.matches, Dn(Ae, e, ({ matches: i }) => {
    ii && t.matches || (ii = i);
  });
}
...
if (typeof ge == "object") {
  ...
  wr = !0;
} else typeof navigator == "object" && !An ? (Te = navigator.userAgent, Ei = Te.indexOf("Windows") >= 0, Bi = Te.indexOf("Macintosh") >= 0, (Te.indexOf("Macintosh") >= 0 || Te.indexOf("iPad") >= 0 || Te.indexOf("iPhone") >= 0) && navigator.maxTouchPoints && navigator.maxTouchPoints > 0, Nt = Te.indexOf("Linux") >= 0, Te?.indexOf("Mobi") >= 0, Ht = globalThis._VSCODE_NLS_LANGUAGE || rt, Rt = navigator.language.toLowerCase(), us = Rt) : console.error("Unable to resolve platform.");
var br = Ei, Le = Bi, On = Nt, _s = wr, Me = Te, ze = Ht, In;
((e) => {
  function t() {
    return ze;
  }
...
var Nn = typeof Ze.postMessage == "function" && !Ze.importScripts;
(() => {
  if (Nn) {
    let e = [];
    ...
    return (i) => {
      let s = ++t;
      e.push({ id: s, callback: i }), Ze.postMessage({ vscodeScheduleAsyncWork: s }, "*");
    };
  }
  return (e) => setTimeout(e);
})();
var Hn = !!(Me && Me.indexOf("Chrome") >= 0);
Me && Me.indexOf("Firefox") >= 0;
!Hn && Me && Me.indexOf("Safari") >= 0;
Me && Me.indexOf("Edg/") >= 0;
Me && Me.indexOf("Android") >= 0;
var it = typeof navigator == "object" ? navigator : {};
_s || document.queryCommandSupported && document.queryCommandSupported("copy") || it && it.clipboard && it.clipboard.writeText, _s || it && it.clipboard && it.clipboard.readText;
var es = class {
  constructor() {
...
}, si = new es(), fs = new es(), ps = new es(), Wn = new Array(230), yr;
((e) => {
  function t(h) {
    return si.keyCodeToStr(h);
  }
  e.toString = t;
  function i(h) {
    return si.strToKeyCode(h);
  }
  e.fromString = i;
  function s(h) {
    return fs.keyCodeToStr(h);
  }
  e.toUserSettingsUS = s;
  function r(h) {
    return ps.keyCodeToStr(h);
  }
  e.toUserSettingsGeneral = r;
  function n(h) {
    return fs.strToKeyCode(h) || ps.strToKeyCode(h);
  }
...
var zn = class Cr {
  ...
  equals(t) {
    return t instanceof Cr && this.ctrlKey === t.ctrlKey && this.shiftKey === t.shiftKey && this.altKey === t.altKey && this.metaKey === t.metaKey && this.keyCode === t.keyCode;
  }
  getHashCode() {
...
function $n(e) {
  ...
  else if (Ln && (Le && t === 93 || !Le && t === 92))
    return 57;
  return Wn[t] || 0;
}
var Kn = Le ? 256 : 2048, Un = 512, qn = 1024, Vn = Le ? 2048 : 256, gs = class {
  constructor(e) {
  ...
  _computeKeybinding() {
    ...
    let t = 0;
    return this.ctrlKey && (t |= Kn), this.altKey && (t |= Un), this.shiftKey && (t |= qn), this.metaKey && (t |= Vn), t |= e, t;
  }
  _computeKeyCodeChord() {
    let e = 0;
    return this.keyCode !== 5 && this.keyCode !== 4 && this.keyCode !== 6 && this.keyCode !== 57 && (e = this.keyCode), new zn(this.ctrlKey, this.shiftKey, this.altKey, this.metaKey, e);
  }
...
var Xn = class {
  static getSameOriginWindowChain(e) {
    ...
    if (!t) {
      ...
      let i = e, s;
      do
        s = Yn(i), s ? t.push({ window: new WeakRef(i), iframeElement: i.frameElement || null }) : t.push({ window: new WeakRef(i), iframeElement: null }), i = s;
      while (i);
    }
    return t.slice(0);
  }
  ...
  constructor(e, t) {
    ...
    let i = Xn.getPositionOfChildWindowRelativeToAncestorWindow(e, t.view);
  ...
  constructor(e, t = 0, i = 0) {
    ...
    if (e) {
      ...
      if (typeof r.wheelDeltaY < "u") s ? this.deltaY = r.wheelDeltaY / (120 * o) : this.deltaY = r.wheelDeltaY / 120;
        ...
        let h = e;
        h.deltaMode === h.DOM_DELTA_LINE ? xi && !Le ? this.deltaY = -e.deltaY / 3 : this.deltaY = -e.deltaY : this.deltaY = -e.deltaY / 40;
      }
      if (typeof r.wheelDeltaX < "u") Mn && br ? this.deltaX = -(r.wheelDeltaX / 120) : s ? this.deltaX = r.wheelDeltaX / (120 * o) : this.deltaX = r.wheelDeltaX / 120;
      else if (typeof n.HORIZONTAL_AXIS < "u" && n.axis === n.HORIZONTAL_AXIS) this.deltaX = -e.detail / 3;
      else if (e.type === "wheel") {
        let h = e;
        h.deltaMode === h.DOM_DELTA_LINE ? xi && !Le ? this.deltaX = -e.deltaX / 3 : this.deltaX = -e.deltaX : this.deltaX = -e.deltaX / 40;
      }
...
((e) => {
  function t(i) {
    return i === e.None || i === e.Cancelled || i instanceof Gn ? !0 : !i || typeof i != "object" ? !1 : typeof i.isCancellationRequested == "boolean" && typeof i.onCancellationRequested == "function";
  }
...
var Gn = class {
  ...
  cancelAndSet(e, t) {
    if (this._isDisposed) throw new Si("Calling 'cancelAndSet' on a disposed TimeoutTimer");
    this.cancel(), this._token = setTimeout(() => {
      this._token = -1, e();
    }, t);
  }
  setIfNotSet(e, t) {
    if (this._isDisposed) throw new Si("Calling 'setIfNotSet' on a disposed TimeoutTimer");
  ...
  cancelAndSet(e, t, i = globalThis) {
    if (this.isDisposed) throw new Si("Calling 'cancelAndSet' on a disposed IntervalTimer");
    this.cancel();
    let s = i.setInterval(() => {
      e();
    }, t);
...
(function() {
  let e = /* @__PURE__ */ new Map(), t = /* @__PURE__ */ new Map(), i = /* @__PURE__ */ new Map(), s = /* @__PURE__ */ new Map(), r = (n) => {
    i.set(n, !1);
    let o = e.get(n) ?? [];
    for (t.set(n, o), e.set(n, []), s.set(n, !0); o.length > 0; ) o.sort(bs.sort), o.shift().execute();
    s.set(n, !1);
  };
  is = (n, o, h = 0) => {
...
var pt = class ae extends T {
  ...
  onTouchStart(t) {
    ...
    for (let s = 0, r = t.targetTouches.length; s < r; s++) {
      ...
      let o = this.newGestureEvent(De.Start, n.target);
...
var oo = pt, ss = class extends T {
  ...
  withScrollDimensions(t, i) {
    return new Di(this._forceIntegerValues, typeof t.width < "u" ? t.width : this.width, typeof t.scrollWidth < "u" ? t.scrollWidth : this.scrollWidth, i ? this.rawScrollLeft : this.scrollLeft, typeof t.height < "u" ? t.height : this.height, typeof t.scrollHeight < "u" ? t.scrollHeight : this.scrollHeight, i ? this.rawScrollTop : this.scrollTop);
  }
  withScrollPosition(t) {
    return new Di(this._forceIntegerValues, this.width, this.scrollWidth, typeof t.scrollLeft < "u" ? t.scrollLeft : this.rawScrollLeft, this.height, this.scrollHeight, typeof t.scrollTop < "u" ? t.scrollTop : this.rawScrollTop);
  }
  ...
  setScrollPositionSmooth(e, t) {
    ...
    if (this._smoothScrolling) {
      ...
      let s;
      t ? s = new ks(this._smoothScrolling.from, i, this._smoothScrolling.startTime, this._smoothScrolling.duration) : s = this._smoothScrolling.combine(this._state, i, this._smoothScrollDuration), this._smoothScrolling.dispose(), this._smoothScrolling = s;
    } else {
      let i = this._state.withScrollPosition(e);
      this._smoothScrolling = ks.start(this._state, i, this._smoothScrollDuration);
    }
...
var ks = class Ri {
  ...
  _initAnimation(t, i, s) {
    if (Math.abs(t - i) > 2.5 * s) {
      let r, n;
      return t < i ? (r = t + 0.75 * s, n = i - 0.75 * s) : (r = t - 0.75 * s, n = i + 0.75 * s), co(ri(t, r), ri(n, i), 0.33);
    }
    return ri(t, i);
  }
  dispose() {
  ...
  _tick(t) {
    ...
    return new Cs(this.to.scrollLeft, this.to.scrollTop, !0);
  }
  combine(t, i, s) {
    return Ri.start(t, i, s);
  }
  static start(t, i, s) {
    s = s + 10;
    let r = Date.now() - 10;
    return new Ri(t, i, r, s);
  }
};
function uo(e) {
  return Math.pow(e, 3);
...
var fo = class extends T {
  ...
  clone() {
    return new Li(this._arrowSize, this._scrollbarSize, this._oppositeScrollbarSize, this._visibleSize, this._scrollSize, this._scrollPosition);
  }
  setVisibleSize(t) {
    let i = Math.round(t);
...
var wo = Mi, bo = class extends ss {
  ...
  _onMouseWheel(e) {
    ...
    if (e.deltaY || e.deltaX) {
      ...
      let o = !Le && e.browserEvent && e.browserEvent.shiftKey;
  ...
  _scheduleHide() {
    !this._mouseIsOver && !this._isDragging && this._hideTimeout.cancelAndSet(() => this._hide(), mo);
  }
}, yo = class extends bo {
  constructor(e, t, i) {
    super(e, t, i);
...
var ko = class {
  ...
  _refreshDrawConstants() {
    ...
    Fe.full = this._canvas.width, Fe.left = e, Fe.center = t, Fe.right = e, this._refreshDrawHeightConstants(), lt.full = 1, lt.left = 1, lt.center = 1 + Fe.left, lt.right = 1 + Fe.left + Fe.center;
  }
  ...
  _renderColorZone(e) {
    this._ctx.fillStyle = e.color, this._ctx.fillRect(lt[e.position || "full"], Math.round((this._canvas.height - 1) * (e.startBufferLine / this._bufferService.buffers.active.lines.length) - Ee[e.position || "full"] / 2), Fe[e.position || "full"], Math.round((this._canvas.height - 1) * ((e.endBufferLine - e.startBufferLine) / this._bufferService.buffers.active.lines.length) + Ee[e.position || "full"]));
  }
  _queueRefresh(e, t) {
...
var Wt;
((e) => (e.PAD = "", e.HOP = "", e.BPH = "", e.NBH = "", e.IND = "", e.NEL = "", e.SSA = "", e.ESA = "", e.HTS = "", e.HTJ = "", e.VTS = "", e.PLD = "", e.PLU = "", e.RI = "", e.SS2 = "", e.SS3 = "", e.DCS = "", e.PU1 = "", e.PU2 = "", e.STS = "", e.CCH = "", e.MW = "", e.SPA = "", e.EPA = "", e.SOS = "", e.SGCI = "", e.SCI = "", e.CSI = "", e.ST = "", e.OSC = "", e.PM = "", e.APC = ""))(Wt ||= {});
var Dr;
((e) => e.ST = `${g.ESC}\\`)(Dr ||= {});
var Ai = class {
...
var xo = class extends kt {
  ...
  _getJoinedRanges(e, t, i, s, r) {
    ...
    for (let h = 1; h < this._characterJoiners.length; h++) try {
      ...
      for (let a = 0; a < l.length; a++) Ut._mergeRanges(o, l[a]);
    } catch (l) {
      console.error(l);
    }
...
var ni = "xterm-dom-renderer-owner-", Se = "xterm-rows", Pt = "xterm-fg-", Ds = "xterm-bg-", ct = "xterm-focus", Tt = "xterm-selection", To = 1, Ii = class extends T {
  ...
  handleBlur() {
    this._rowContainer.classList.remove(ct), this.renderRows(0, this._bufferService.rows - 1);
  }
  handleFocus() {
    this._rowContainer.classList.add(ct), this.renderRows(this._bufferService.buffer.y, this._bufferService.buffer.y);
  }
  handleSelectionChanged(e, t, i) {
...
var Hi = class {
  ...
  getCoords(e, t, i, s, r) {
    return Wo(window, e, t, i, s, this._charSizeService.hasValidSize, this._renderService.dimensions.css.cell.width, this._renderService.dimensions.css.cell.height, r);
  }
...
Xr(Lr, { getSafariVersion: () => $o, isChromeOS: () => Ar, isFirefox: () => Mr, isIpad: () => Ko, isIphone: () => Uo, isLegacyEdge: () => Fo, isLinux: () => ns, isMac: () => qt, isNode: () => Gt, isSafari: () => Pr, isWindows: () => Tr });
var Gt = typeof process < "u" && "title" in process, Et = Gt ? "node" : navigator.userAgent, Bt = Gt ? "node" : navigator.platform, Mr = Et.includes("Firefox"), Fo = Et.includes("Edge"), Pr = /^((?!chrome|android).)*safari/i.test(Et);
function $o() {
  if (!Pr) return 0;
  let e = Et.match(/Version\/(\d+)/);
  return e === null || e.length < 2 ? 0 : parseInt(e[1]);
}
var qt = ["Macintosh", "MacIntel", "MacPPC", "Mac68K"].includes(Bt), Ko = Bt === "iPad", Uo = Bt === "iPhone", Tr = ["Windows", "Win16", "Win32", "WinCE"].includes(Bt), ns = Bt.indexOf("Linux") >= 0, Ar = /\bCrOS\b/.test(Et), Or = class {
  constructor() {
...
}, Vt = !Gt && "requestIdleCallback" in window ? Vo : qo, Yo = class {
  constructor() {
    this._queue = new Vt();
  }
  set(e) {
...
function jo(e, t, i, s) {
  ...
  if (!i.buffer.hasScrollback) return Zo(r, n, e, t, i, s) + Jt(n, t, i, s) + Qo(r, n, e, t, i, s);
  let o;
  if (n === t) return o = r > e ? "D" : "C", yt(Math.abs(r - e), bt(o, s));
  o = n > t ? "D" : "C";
  let h = Math.abs(n - t), l = Jo(n > t ? e : r, i) + (h - 1) * i.cols + 1 + Go(n > t ? r : e);
  return yt(l, bt(o, s));
}
function Go(e, t) {
  return e - 1;
...
function Zo(e, t, i, s, r, n) {
  return Jt(t, s, r, n).length === 0 ? "" : yt(Nr(e, t, e, t - et(t, r), !1, r).length, bt("D", n));
}
function Jt(e, t, i, s) {
  let r = e - et(e, i), n = t - et(t, i), o = Math.abs(r - n) - ea(e, t, i);
  return yt(o, bt(Ir(e, t), s));
}
function Qo(e, t, i, s, r, n) {
  let o;
  Jt(t, s, r, n).length > 0 ? o = s - et(s, r) : o = t;
  let h = s, l = ta(e, t, i, s, r, n);
  return yt(Nr(e, o, i, h, l === "C", r).length, bt(l, n));
}
function ea(e, t, i) {
...
function ta(e, t, i, s, r, n) {
  let o;
  return Jt(i, s, r, n).length > 0 ? o = s - et(s, r) : o = t, e < i && o <= s || e >= i && o < s ? "C" : "D";
}
function Ir(e, t) {
  return e > t ? "A" : "B";
}
function Nr(e, t, i, s, r, n) {
  let o = e, h = t, l = "";
...
var oi = 50, sa = 15, ra = 50, na = 500, oa = " ", aa = new RegExp(oa, "g"), zi = class extends T {
  ...
  get selectionText() {
    ...
    return s.map((r) => r.replace(aa, " ")).join(Tr ? `\r
` : `
`);
  }
  clearSelection() {
  ...
  refresh(e) {
    this._refreshAnimationFrame || (this._refreshAnimationFrame = this._coreBrowserService.window.requestAnimationFrame(() => this._refresh())), ns && e && this.selectionText.length && this._onLinuxMouseSelection.fire(this.selectionText);
  }
  _refresh() {
  ...
  _selectWordAtCursor(e, t) {
    ...
    if (i) return this._model.selectionStart = [i.start.x - 1, i.start.y - 1], this._model.selectionStartLength = Rs(i, this._bufferService.cols), this._model.selectionEnd = void 0, !0;
  ...
  _getMouseEventScrollAmount(e) {
    let t = rs(this._coreBrowserService.window, e, this._screenElement)[1], i = this._renderService.dimensions.css.canvas.height;
    return t >= 0 && t <= i ? 0 : (t > i && (t -= i), t = Math.min(Math.max(t, -oi), oi), t /= oi, t / Math.abs(t) + Math.round(t * (sa - 1)));
  }
  shouldForceSelection(e) {
    return qt ? e.altKey && this._optionsService.rawOptions.macOptionClickForcesSelection : e.shiftKey;
  }
  handleMouseDown(e) {
  ...
  _addMouseDownListeners() {
    this._screenElement.ownerDocument && (this._screenElement.ownerDocument.addEventListener("mousemove", this._mouseMoveListener), this._screenElement.ownerDocument.addEventListener("mouseup", this._mouseUpListener)), this._dragScrollIntervalTimer = this._coreBrowserService.window.setInterval(() => this._dragScroll(), ra);
  }
  ...
  shouldColumnSelect(e) {
    return e.altKey && !(qt && this._optionsService.rawOptions.macOptionClickForcesSelection);
  }
  _handleMouseMove(e) {
  ...
  _handleMouseUp(e) {
    ...
    if (this._removeMouseDownListeners(), this.selectionText.length <= 1 && t < na && e.altKey && this._optionsService.rawOptions.altClickMovesCursor) {
...
var Ls = class {
  ...
  constructor() {
    this._color = new Ls(), this._css = new Ls();
  }
  setCss(e, t, i) {
    this._css.set(e, t, i);
  }
...
var la = class {
  ...
  constructor() {
    this._services = new la(), this._services.set(Gi, this);
  }
  setService(e, t) {
  ...
  _updateLogLevel() {
    this._logLevel = da[this._optionsService.rawOptions.logLevel];
  }
  _evalLazyOptionalParams(e) {
    for (let t = 0; t < e.length; t++) typeof e[t] == "function" && (e[t] = e[t]());
  }
  _log(e, t, i) {
    this._evalLazyOptionalParams(i), e.call(console, (this._optionsService.options.logger ? "" : ua) + t, ...i);
  }
  trace(e, ...t) {
...
var As = class extends T {
  ...
  resize(t, i) {
    ...
    return this.length = t, s * 4 * ai < this._data.buffer.byteLength;
  }
  cleanupMemory() {
    if (this._data.length * 4 * ai < this._data.buffer.byteLength) {
...
function ga(e, t, i) {
  let s = [], r = e.map((l, a) => Ct(e, a, t)).reduce((l, a) => l + a), n = 0, o = 0, h = 0;
  for (; h < r; ) {
    if (r - h < i) {
      s.push(r - h);
      break;
...
var Os = 4294967295, Is = class {
  ...
  getWhitespaceCell(e) {
    return e ? (this._whitespaceCell.fg = e.fg, this._whitespaceCell.bg = e.bg, this._whitespaceCell.extended = e.extended) : (this._whitespaceCell.fg = 0, this._whitespaceCell.bg = 0, this._whitespaceCell.extended = new $t()), this._whitespaceCell;
  }
  getBlankLine(e, t) {
    return new vt(this._bufferService.cols, this.getNullCell(e), t);
  }
  get hasScrollback() {
  ...
  clear() {
    this.ydisp = 0, this.ybase = 0, this.y = 0, this.x = 0, this.lines = new As(this._getCorrectBufferLength(this._rows)), this.scrollTop = 0, this.scrollBottom = this._rows - 1, this.setupTabStops();
  }
  resize(e, t) {
    ...
    if (r > this.lines.maxLength && (this.lines.maxLength = r), this.lines.length > 0) {
      ...
      let n = 0;
      if (this._rows < t) for (let o = this._rows; o < t; o++) this.lines.length < t + this.ybase && (this._optionsService.rawOptions.windowsMode || this._optionsService.rawOptions.windowsPty.backend !== void 0 || this._optionsService.rawOptions.windowsPty.buildNumber !== void 0 ? this.lines.push(new vt(e, i)) : this.ybase > 0 && this.lines.length <= this.ybase + this.y + n + 1 ? (this.ybase--, n++, this.ydisp > 0 && this.ydisp--) : this.lines.push(new vt(e, i)));
  ...
  _reflowLarger(e, t) {
    let i = this._optionsService.rawOptions.reflowCursorLine, s = _a(this.lines, this._cols, e, this.ybase + this.y, this.getNullCell(j), i);
    if (s.length > 0) {
      let r = fa(this.lines, s);
      pa(this.lines, r.layout), this._reflowLargerAdjustViewport(e, t, r.countRemoved);
    }
  }
  _reflowLargerAdjustViewport(e, t, i) {
    let s = this.getNullCell(j), r = i;
    for (; r-- > 0; ) this.ybase === 0 ? (this.y > 0 && this.y--, this.lines.length < t && this.lines.push(new vt(e, s))) : (this.ydisp === this.ybase && this.ydisp--, this.ybase--);
...
var st = { cols: 80, rows: 24, cursorBlink: !1, cursorStyle: "block", cursorWidth: 1, cursorInactiveStyle: "outline", customGlyphs: !0, drawBoldTextInBrightColors: !0, documentOverride: null, fastScrollModifier: "alt", fastScrollSensitivity: 5, fontFamily: "monospace", fontSize: 15, fontWeight: "normal", fontWeightBold: "bold", ignoreBracketedPasteMode: !1, lineHeight: 1, letterSpacing: 0, linkHandler: null, logLevel: "info", logger: null, scrollback: 1e3, scrollOnEraseInDisplay: !1, scrollOnUserInput: !0, scrollSensitivity: 1, screenReaderMode: !1, smoothScrollDuration: 0, macOptionIsMeta: !1, macOptionClickForcesSelection: !1, minimumContrastRatio: 1, disableStdin: !1, allowProposedApi: !1, allowTransparency: !1, tabStopWidth: 8, theme: {}, reflowCursorLine: !1, rescaleOverlappingGlyphs: !1, rightClickSelectsWord: qt, windowOptions: {}, windowsMode: !1, windowsPty: {}, wordSeparator: " ()[]{}',\"`", altClickMovesCursor: !0, convertEol: !1, termName: "xterm", cancelEvents: !1, overviewRuler: {} }, Sa = ["normal", "bold", "100", "200", "300", "400", "500", "600", "700", "800", "900"], wa = class extends T {
  ...
  _setupOptions() {
    let e = (i) => {
      if (!(i in st)) throw new Error(`No option with key "${i}"`);
  ...
  _sanitizeAndValidateOption(e, t) {
    switch (e) {
      case "cursorStyle":
        if (t || (t = st[e]), !ba(t)) throw new Error(`"${t}" is not a valid value for ${e}`);
        break;
      case "wordSeparator":
        t || (t = st[e]);
        break;
...
var li = String.fromCharCode, zs = { DEFAULT: (e) => {
  let t = [hi(e, !1) + 32, e.col + 32, e.row + 32];
  return t[0] > 255 || t[1] > 255 || t[2] > 255 ? "" : `\x1B[M${li(t[0])}${li(t[1])}${li(t[2])}`;
}, SGR: (e) => {
  let t = e.action === 0 && e.button !== 4 ? "m" : "M";
  return `\x1B[<${hi(e, !0)};${e.col};${e.row}${t}`;
}, SGR_PIXELS: (e) => {
  let t = e.action === 0 && e.button !== 4 ? "m" : "M";
...
var ka = class {
  ...
  getStringCellWidth(t) {
    ...
    for (let n = 0; n < r; ++n) {
      ...
      let h = this.charProperties(o, s), l = Ft.extractWidth(h);
      Ft.extractShouldJoin(h) && (l -= Ft.extractWidth(s)), i += l, s = h;
    }
    return i;
  }
  charProperties(t, i) {
...
var ut = 2147483647, Ea = 256, Kr = class Vi {
  constructor(t = 32, i = 32) {
    if (this.maxLength = t, this.maxSubParamsLength = i, i > Ea) throw new Error("maxSubParamsLength must not be greater than 256");
  ...
  clone() {
    let t = new Vi(this.maxLength, this.maxSubParamsLength);
  ...
  addParam(t) {
    ...
    this._subParamsIdx[this.length] = this._subParamsLength << 8 | this._subParamsLength, this.params[this.length++] = t > ut ? ut : t;
  }
  addSubParam(t) {
    if (this._digitIsSub = !0, !!this.length) {
      ...
      if (t < -1) throw new Error("values lesser than -1 are not allowed");
      this._subParams[this._subParamsLength++] = t > ut ? ut : t, this._subParamsIdx[this.length - 1]++;
    }
  }
  hasSubParams(t) {
  ...
  addDigit(t) {
    ...
    s[i - 1] = ~r ? Math.min(r * 10 + t, ut) : t;
  }
}, _t = [], Ba = class {
  constructor() {
    this._state = 0, this._active = _t, this._id = -1, this._handlers = /* @__PURE__ */ Object.create(null), this._handlerFb = () => {
  ...
  reset() {
    ...
    this._stack.paused = !1, this._active = _t, this._id = -1, this._state = 0;
  }
  _start() {
    if (this._active = this._handlers[this._id] || _t, !this._active.length) this._handlerFb(this._id, "START");
    else for (let e = this._active.length - 1; e >= 0; e--) this._active[e].start();
  }
  _put(e, t, i) {
    if (!this._active.length) this._handlerFb(this._id, "PUT", Xt(e, t, i));
  ...
  put(e, t, i) {
    this._hitLimit || (this._data += Xt(e, t, i), this._data.length > 1e7 && (this._data = "", this._hitLimit = !0));
  }
  end(e) {
    let t = !1;
  ...
  constructor() {
    this._handlers = /* @__PURE__ */ Object.create(null), this._active = ft, this._ident = 0, this._handlerFb = () => {
    }, this._stack = { paused: !1, loopPosition: 0, fallThrough: !1 };
  }
  dispose() {
    this._handlers = /* @__PURE__ */ Object.create(null), this._handlerFb = () => {
  ...
  reset() {
    ...
    this._stack.paused = !1, this._active = ft, this._ident = 0;
  }
  hook(e, t) {
    if (this.reset(), this._ident = e, this._active = this._handlers[e] || ft, !this._active.length) this._handlerFb(this._ident, "HOOK", t);
    else for (let i = this._active.length - 1; i >= 0; i--) this._active[i].hook(t);
  }
  put(e, t, i) {
    if (!this._active.length) this._handlerFb(this._ident, "PUT", Xt(e, t, i));
    else for (let s = this._active.length - 1; s >= 0; s--) this._active[s].put(e, t, i);
  }
  unhook(e, t = !0) {
    ...
    this._active = ft, this._ident = 0;
  }
}, St = new Kr();
St.addParam(0);
var $s = class {
  constructor(e) {
    this._handler = e, this._data = "", this._params = St, this._hitLimit = !1;
  }
  hook(e) {
    this._params = e.length > 1 || e.params[0] ? e.clone() : St, this._data = "", this._hitLimit = !1;
  }
  put(e, t, i) {
    this._hitLimit || (this._data += Xt(e, t, i), this._data.length > 1e7 && (this._data = "", this._hitLimit = !0));
  }
  unhook(e) {
    let t = !1;
    if (this._hitLimit) t = !1;
    else if (e && (t = this._handler(this._data, this._params), t instanceof Promise)) return t.then((i) => (this._params = St, this._data = "", this._hitLimit = !1, i));
    return this._params = St, this._data = "", this._hitLimit = !1, t;
  }
}, Ra = class {
  constructor(e) {
...
}, Pa = /^([\da-f])\/([\da-f])\/([\da-f])$|^([\da-f]{2})\/([\da-f]{2})\/([\da-f]{2})$|^([\da-f]{3})\/([\da-f]{3})\/([\da-f]{3})$|^([\da-f]{4})\/([\da-f]{4})\/([\da-f]{4})$/, Ta = /^[\da-f]+$/;
function Ks(e) {
  if (!e) return;
  let t = e.toLowerCase();
  if (t.indexOf("rgb:") === 0) {
  ...
  } else if (t.indexOf("#") === 0 && (t = t.slice(1), Ta.exec(t) && [3, 6, 9, 12].includes(t.length))) {
...
function Aa(e, t = 16) {
  let [i, s, r] = e;
  return `rgb:${di(i, t)}/${di(s, t)}/${di(r, t)}`;
}
var Oa = { "(": 0, ")": 1, "*": 2, "+": 3, "-": 1, ".": 2 }, $e = 131072, Us = 10;
function qs(e, t) {
...
var Vs = 5e3, Ys = 0, Ia = class extends T {
  ...
  _logSlowResolvingAsync(e) {
    this._logService.logLevel <= 3 && Promise.race([e, new Promise((t, i) => setTimeout(() => i("#SLOW_TIMEOUT"), Vs))]).catch((t) => {
      if (t !== "#SLOW_TIMEOUT") throw t;
      console.warn(`async parser handler taking longer than ${Vs} ms`);
    });
  }
  _getCurrentLinkId() {
  ...
  registerDcsHandler(e, t) {
    return this._parser.registerDcsHandler(e, new $s(t));
  }
  registerEscHandler(e, t) {
  ...
  windowOptions(e) {
    if (!qs(e.params[0], this._optionsService.rawOptions.windowOptions)) return !0;
    ...
    switch (e.params[0]) {
      ...
      case 18:
        ...
        break;
      case 22:
        (t === 0 || t === 2) && (this._windowTitleStack.push(this._windowTitle), this._windowTitleStack.length > Us && this._windowTitleStack.shift()), (t === 0 || t === 1) && (this._iconNameStack.push(this._iconName), this._iconNameStack.length > Us && this._iconNameStack.shift());
        break;
      case 23:
  ...
  setOrReportIndexedColor(e) {
    ...
    for (; i.length > 1; ) {
      ...
      if (/^\d+$/.exec(s)) {
        let n = parseInt(s);
        if (Xs(n)) if (r === "?") t.push({ type: 0, index: n });
        else {
          let o = Ks(r);
  ...
  markRangeDirty(e, t) {
    e > t && (Ys = e, e = t, t = Ys), e < this.start && (this.start = e), t > this.end && (this.end = t);
  }
  markAllDirty() {
...
var Na = 5e7, js = 12, Ha = 50, Wa = class extends T {
  ...
  write(e, t) {
    if (this._pendingData > Na) throw new Error("write data discarded, use flow control to avoid losing data");
  ...
  _innerWrite(e = 0, t = !0) {
    ...
    for (; this._writeBuffer.length > this._bufferOffset; ) {
      ...
      if (r) {
        let o = (h) => performance.now() - i >= js ? setTimeout(() => this._innerWrite(0, h)) : this._innerWrite(i, h);
      ...
      if (n && n(), this._bufferOffset++, this._pendingData -= s.length, performance.now() - i >= js) break;
    }
    this._writeBuffer.length > this._bufferOffset ? (this._bufferOffset > Ha && (this._writeBuffer = this._writeBuffer.slice(this._bufferOffset), this._callbacks = this._callbacks.slice(this._bufferOffset), this._bufferOffset = 0), setTimeout(() => this._innerWrite())) : (this._writeBuffer.length = 0, this._callbacks.length = 0, this._pendingData = 0, this._bufferOffset = 0), this._onWriteParsed.fire();
  }
}, Xi = class {
  constructor(e) {
...
var Gs = !1, za = class extends T {
  ...
  writeSync(e, t) {
    this._logService.logLevel <= 3 && !Gs && (this._logService.warn("writeSync is unreliable and will be removed soon."), Gs = !0), this._writeBuffer.writeSync(e, t);
  }
  input(e, t = !0) {
    this.coreService.triggerDataEvent(e, t);
  }
  resize(e, t) {
    isNaN(e) || isNaN(t) || (e = Math.max(e, Fr), t = Math.max(t, $r), this._bufferService.resize(e, t));
  }
  scroll(e, t = !1) {
    ...
    default:
      if (e.ctrlKey && !e.shiftKey && !e.altKey && !e.metaKey) e.keyCode >= 65 && e.keyCode <= 90 ? r.key = String.fromCharCode(e.keyCode - 64) : e.keyCode === 32 ? r.key = g.NUL : e.keyCode >= 51 && e.keyCode <= 55 ? r.key = String.fromCharCode(e.keyCode - 51 + 27) : e.keyCode === 56 ? r.key = g.DEL : e.keyCode === 219 ? r.key = g.ESC : e.keyCode === 220 ? r.key = g.FS : e.keyCode === 221 && (r.key = g.GS);
        ...
        if (o) r.key = g.ESC + o;
          ...
          e.shiftKey || (h = h.toLowerCase()), r.key = g.ESC + h, r.cancel = !0;
        }
  ...
  *getDecorationsAtCell(e, t, i) {
  ...
  forEachDecorationAtCell(e, t, i, s) {
    this._decorations.forEachByKey(t, (r) => {
      ui = r.options.x ?? 0, Js = ui + (r.options.width ?? 1), e >= ui && e < Js && (!i || (r.options.layer ?? "bottom") === i) && s(r);
    });
  }
}, qa = class extends qe {
  constructor(e) {
...
`))), this._register(this._terminal.onA11yTab((n) => this._handleTab(n))), this._register(this._terminal.onKey((n) => this._handleKey(n.key))), this._register(this._terminal.onBlur(() => this._clearLiveRegion())), this._register(this._renderService.onDimensionsChange(() => this._refreshRowsDimensions())), this._register(D(r, "selectionchange", () => this._handleSelectionChange())), this._register(this._coreBrowserService.onDprChange(() => this._refreshRowsDimensions())), this._refreshRowsDimensions(), this._refreshRows(), this._register(F(() => {
  ...
  _handleChar(e) {
    this._liveRegionLineCount < Zs + 1 && (this._charsToConsume.length > 0 ? this._charsToConsume.shift() !== e && (this._charsToAnnounce += e) : this._charsToAnnounce += e, e === `
` && (this._liveRegionLineCount++, this._liveRegionLineCount === Zs + 1 && (this._liveRegion.textContent += fi.get())));
  }
  _clearLiveRegion() {
...
var ji = class extends T {
  ...
  _handleMouseUp(e) {
    ...
    let t = this._positionFromMouseEvent(e, this._element, this._mouseService);
    t && this._mouseDownLink && Xa(this._mouseDownLink.link, this._currentLink.link) && this._linkAtPosition(this._currentLink.link, t) && this._currentLink.link.activate(e, this._currentLink.link.text);
  }
...
var ja = class extends za {
  ...
  _handleScreenReaderModeOptionChange(e) {
    e ? !this._accessibilityManager.value && this._renderService && (this._accessibilityManager.value = this._instantiationService.createInstance(Yt, this)) : this._accessibilityManager.clear();
  }
  ...
  open(e) {
    ...
    })), this._selectionService = this._register(this._instantiationService.createInstance(zi, this.element, this.screenElement, s)), this._instantiationService.setService(an, this._selectionService), this._register(this._selectionService.onRequestScrollLines((r) => this.scrollLines(r.amount, r.suppressScrollEvent))), this._register(this._selectionService.onSelectionChange(() => this._onSelectionChange.fire())), this._register(this._selectionService.onRequestRedraw((r) => this._renderService.handleSelectionChanged(r.start, r.end, r.columnSelectMode))), this._register(this._selectionService.onLinuxMouseSelection((r) => {
  ...
  _createRenderer() {
    return this._instantiationService.createInstance(Ii, this, this._document, this.element, this.screenElement, this._viewportElement, this._helperContainer, this.linkifier);
  }
  bindMouse() {
  ...
  paste(e) {
    tr(e, this.textarea, this.coreService, this.optionsService);
  }
  ...
  _keyDown(e) {
    ...
    let i = $a(e, this.coreService.decPrivateModes.applicationCursorKeys, this.browser.isMac, this.options.macOptionIsMeta);
  ...
  _keyUp(e) {
    this._keyDownSeen = !1, !(this._customKeyEventHandler && this._customKeyEventHandler(e) === !1) && (Ga(e) || this.focus(), this.updateCursorStyle(e), this._keyPressHandled = !1);
  }
  _keyPress(e) {
    let t;
...
var Ja = class {
  ...
  _checkReadonlyOptions(e) {
    if (ih.includes(e)) throw new Error(`Option "${e}" can only be set in the constructor`);
  }
  _checkProposedApi() {
  ...
  get parser() {
    return this._parser || (this._parser = new eh(this._core)), this._parser;
  }
  get unicode() {
    return this._checkProposedApi(), new th(this._core);
  }
  get textarea() {
  ...
  get buffer() {
    return this._buffer || (this._buffer = this._register(new Qa(this._core))), this._buffer;
  }
  get markers() {
...
`, t);
  ...
  _verifyIntegers(...e) {
    for (Be of e) if (Be === 1 / 0 || isNaN(Be) || Be % 1 !== 0) throw new Error("This API only accepts integers");
  }
